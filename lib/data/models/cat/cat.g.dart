...
extension CatQuerySortBy on QueryBuilder<Cat, Cat, QSortBy> {
  QueryBuilder<Cat, Cat, QAfterSortBy> sortByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<Cat, Cat, QAfterSortBy> sortByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CatQuerySortThenBy on QueryBuilder<Cat, Cat, QSortThenBy> {
  QueryBuilder<Cat, Cat, QAfterSortBy> thenByAge() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.asc);
    });
  }

  QueryBuilder<Cat, Cat, QAfterSortBy> thenByAgeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'age', Sort.desc);
    });
  }
...
extension CatQueryWhereDistinct on QueryBuilder<Cat, Cat, QDistinct> {
  QueryBuilder<Cat, Cat, QDistinct> distinctByAge() {
    return QueryBuilder.apply(this, (query) {
